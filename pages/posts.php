...
// Get reCAPTCHA site key from .env file
                ...
                <form id="commentForm" method="post" action="../controllers/add_comment.php" class="comment-form">
                    ...
                    <div class="mb-3">
                        <div class="position-relative">
                            <textarea name="content" class="form-control rounded pe-5 py-2 auto-expand-textarea" style="resize: none; overflow-y: hidden; border-radius: 8px;" required placeholder="Viết bình luận..." rows="1"></textarea>
                    ...
                    <?php if ($error == 'limit_1'): ?>
                        ...
                        <div class="g-recaptcha mb-2" data-sitekey="<?php echo $recaptcha_site_key; ?>" data-callback="enableSubmit"></div>
...
<!-- reCAPTCHA auto-submission script -->
<script>
